...
public class GuardianPresenter implements GuardianContract.GuardianPresenter
{
    ...
    @Override
    public void onArticleItemClicked(GuardianArticleResponse.Article article)
    {
        _controller.showNewsItem(article.webUrl);
    }
